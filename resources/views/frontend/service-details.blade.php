...
<!-- Mirrored from truelysell.dreamstechnologies.com/html/template/service-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Jul 2024 07:54:54 GMT -->
...
<img src="assets/img/logo-small.png" class="img-fluid" alt="Logo">
                            ...
                            <li class="has-submenu active">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li class="has-submenu active">
                                        ...
                                        <ul class="submenu">
                                            <li class="active"><a href="service-details.html">Service Details 1</a></li>
                    ...
                    <ul class="nav header-navbar-rht">
                        ...
                        <li class="nav-item">
                            <a class="nav-link header-login" href="login.html"><i class="fa-regular fa-circle-user"></i>
                                Login</a>
                        </li>
                    </ul>
                </nav>
                            ...
                            <ul>
                                <li class="review-box">
                                    ...
                                    <div class="recommend-item">
                                        <a href="#"><img alt="Image" src="assets/img/icons/reply-icon.svg" class="me-2">
                                            Reply</a>
                                ...
                                <li class="review-box">
                                    ...
                                    <div class="reply-area">
                                        <textarea class="form-control mb-0" rows="3"
                            ...
                            <div class="footer-widget footer-contact">
                                ...
                                <div class="footer-contact-info">
                                    ...
                                    <p><span><i class="feather-mail"></i></span> <a
                                            ...
                                            class="__cf_email__"
                                            data-cfemail="a4d0d6d1c1c8ddd7c1c8c8e4c1dcc5c9d4c8c18ac7cbc9">[email&#160;protected]</a>
                                    </p>
    ...
    <script src="assets/js/jquery-3.7.0.min.js" type="5ccd6c3854c16579e3b83553-text/javascript"></script>

    <script src="assets/js/bootstrap.bundle.min.js" type="5ccd6c3854c16579e3b83553-text/javascript"></script>

    <script src="assets/js/feather.min.js" type="5ccd6c3854c16579e3b83553-text/javascript"></script>

    <script src="assets/js/owl.carousel.min.js" type="5ccd6c3854c16579e3b83553-text/javascript"></script>

    <script src="assets/plugins/fancybox/jquery.fancybox.min.js"
        type="5ccd6c3854c16579e3b83553-text/javascript"></script>

    <script src="assets/plugins/select2/js/select2.min.js" type="5ccd6c3854c16579e3b83553-text/javascript"></script>
    ...
    <script src="assets/js/script.js" type="5ccd6c3854c16579e3b83553-text/javascript"></script>
    <script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="5ccd6c3854c16579e3b83553-|49" defer></script>
</body>

<!-- Mirrored from truelysell.dreamstechnologies.com/html/template/service-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Jul 2024 07:55:01 GMT -->
