                    ...
                    <div class="row align-items-center w-100">
                        <div class="col-12 mx-auto bann">
                            <div class="section-search aos" data-aos="fade-up">
                                <h1>Welcome to <span class="truely">ZERO</span><span class="sell">BROKAGE</span>  For Your Home Services  </h1>
                    ...
                    <div class="col-md-2">
                        <a href="#" class="feature-box aos" data-aos="fade-up">
                            <div class="feature-icon">
                                ...
                                <img src="{{ asset('storage/images/' . $subcategory->image) }}"  alt="img">
                                @else
                                    No Image
                                @endif -->
                        ...
                        <div class="owl-carousel service-slider">
                            ...
                            <div class="service-widget aos checkk" data-aos="fade-up">
                                ...
                                <div class="service-img feat-img">
                                    ...
                                    <!-- @if ($menu->image)
                                        <img src="{{ asset('storage/images/' . $menu->image) }}" width="100">
                                    @else
                                        No Image
                                    @endif -->
                ...
                <div class="row aos" data-aos="fade-up">
                    ...
                    <div class="col-lg-4 col-sm-12">
                        <div class="pricing-popular active">
                            <span class="btn popular w-100">Popular</span>
                        </div>
...
<!-- Mirrored from truelysell.dreamstechnologies.com/html/template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Jul 2024 07:51:06 GMT -->
