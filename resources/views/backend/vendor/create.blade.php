            ...
            <div class="main-wrapper">
                        ...
                        <div class="row mx-auto">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="employee_id" class="form-select bg-light-subtle"
                                    ...
                                    <option value="1" {{ old('employee_id') == '1' ? 'selected' : '' }}>employee1</option>
                                    <option value="2" {{ old('employee_id') == '2' ? 'selected' : '' }}>employee2</option>
                                    <option value="3" {{ old('employee_id') == '3' ? 'selected' : '' }}>employee3</option>
                                </select>
                                @error('employee_id')
                            ...
                            <div class="col-md-4">
                                <label for="formFileCategory" class="form-label">Sub-Category <b style="color: red;">*</b></label>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-4 mt-4 mt-md-0">
                        <label for="formFile" class="form-label">Whatsapp<b style="color: red;">*</b></label><span
                            class="mx-3">(Get
                            notification)</span>
                        ...
                        <input name="whatsapp" value="{{ old('whatsapp') }}" class="form-control bg-light-subtle"
                            id="whatsappNumVender" type="text" placeholder="Whatsapp number"
                            aria-label="default input example" onkeyup="validateField(this)" maxlength="10" required>
                    ...
                    <div class="col-md-4 mt-4 mt-md-0">
                        <label for="phoneNumVender" class="form-label">Phone Number<b
                            ...
                            notification)</span>
                        <input name="number" value="{{ old('number') }}" class="form-check-input mx-2" type="checkbox"
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="verified" class="form-select bg-light-subtle" aria-label="Default select example"
                ...
                <div class="row mt-3">
                    <div class="col-md-5 mb-3">
                        <label for="formFile" class="form-label">Official video<b
                            style="color: red;">*</b></label>
                    <input name="video" class="form-control bg-light-subtle" type="file" id="formFile" required>
                    @error('video')
                    <div class="error text-danger ">{{ $message }}</div>
                    @enderror
                    </div>
                    ...
                    <div class="col-md-5">
                        <label for="formFile" class="form-label">Location<b
                            style="color: red;">*</b></label>
