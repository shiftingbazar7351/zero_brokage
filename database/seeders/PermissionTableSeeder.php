...
class PermissionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $permissions = [
            ...
            ['name' => 'menu-list', 'title' => 'Menu List', 'guard_name' => 'web'],
            ['name' => 'menu-create', 'title' => 'Menu Create', 'guard_name' => 'web'],
            ['name' => 'menu-edit', 'title' => 'Menu Edit', 'guard_name' => 'web'],
            ['name' => 'menu-delete', 'title' => 'Menu Delete', 'guard_name' => 'web'],
            ['name' => 'menu-show', 'title' => 'Menu Show', 'guard_name' => 'web'],
            ...
            ['name' => 'newsletter-create', 'title' => 'Newsletter Create', 'guard_name' => 'web'],
            ['name' => 'newsletter-edit', 'title' => 'Newsletter Edit', 'guard_name' => 'web'],
            ['name' => 'newsletter-delete', 'title' => 'Newsletter Delete', 'guard_name' => 'web'],
            ['name' => 'newsletter-show', 'title' => 'Newsletter Show', 'guard_name' => 'web'],
