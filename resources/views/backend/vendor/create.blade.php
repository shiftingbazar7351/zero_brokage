                    ...
                    <form id="addCategoryModal" action="{{ route('vendors.store') }}" method="POST"
                        ...
                        <div class="col-md-3 mt-4 mt-md-0" id="otpSection" style="display: none;">
                            ...
                            <div class="col-md-3 mt-4 mt-md-0">
                                ...
                                <input name="whatsapp" value="{{ old('whatsapp') }}"
                                    ...
                                    onkeyup="validateField(this)" oninput="checkPhoneNumberOrWhatsapp(this)"
                                    maxlength="10" required>
                                <div id="whatsappError" class="text-danger"></div>
                                @error('whatsapp')
                                    <div class="error text-danger ">{{ $message }}</div>
                            ...
                            <div class="col-md-3 mt-4 mt-md-0">
                                ...
                                <input name="number" value="{{ old('number') }}" class="form-control bg-light-subtle"
                                    ...
                                    oninput="checkPhoneNumberOrWhatsapp(this)" required>
                                <div id="phoneError" class="text-danger"></div>
                                @error('number')
                                    <div class="error text-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input name="dob" value="{{ old('dob') }}" class="form-control bg-light-subtle"
                                    type="date" id="dob" placeholder="Enter DOB" required>
                                @error('dob')
                                    <div class="error text-danger ">{{ $message }}</div>
                                @enderror
                            </div>
