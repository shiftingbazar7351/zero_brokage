...
<!-- Mirrored from truelysell.dreamstechnologies.com/html/template/notification.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Jul 2024 07:57:40 GMT -->
<head>
<meta charset="utf-8">
...
<li><a href="provider-coupons.html">Coupouns</a></li>
...
<div class="notification-wrap-date d-flex align-items-center justify-content-between">
<div class="search-input search-calendar-line">
<i class="feather-calendar"></i>
<div class=" mb-0">
<input type="text" class="form-control datetimepicker" placeholder="09-04-2023">
</div>
</div>
<div class="noti-read-delete d-flex align-items-center">
<div class="notification-read">
<a href="javascript:void(0);" class="mark-all"> <i class="feather-check me-2"></i> Mark all as read</a>
</div>
...
<ul class="notification-list">
<li class="notification-message">
<div class="notification-delete-wrap d-flex align-items-center justify-content-between">
<div class="media noti-img d-flex">
<span class="avatar avatar-sm flex-shrink-0">
<img class="avatar-img rounded-circle img-fluid" alt="User Image" src="assets/img/notifications/avatar-01.jpg">
</span>
<div class="media-body flex-grow-1">
<a href="javascript:void(0);"><p class="noti-details">Lex Murphy left 6 comments on Isla Nublar SOC2 compliance report</p></a>
<p class="noti-time"><span class="notification-time">1m ago</span></p>
</div>
</div>
<div class="notification-delete d-flex align-items-center">
<div class="notification-dropdown">
<a href="#" class="d-flex" data-bs-toggle="dropdown"><i class="feather-more-vertical"></i></a>
<div class="dropdown-menu">
<a href="#" class="dropdown-item"><i class="far fa-check-circle me-1"></i> Mark as read</a>
</div>
</div>
...
<div class="media-body flex-grow-1">
<a href="javascript:void(0);"><p class="noti-details">Ray Arnold requested access to UNIX directory tree hierarchy</p></a>
<p class="noti-time"><span class="notification-time">1 min ago</span></p>
<div class="notify-btns">
<button class="btn btn-secondary">Decline</button>
<button class="btn btn-primary">Accept</button>
</div>
...
<div class="media-body flex-grow-1">
<a href="javascript:void(0);"><p class="noti-details">John Hammond created Isla Nublar SOC2 compliance report </p></a>
<p class="noti-time"><span class="notification-time">1m ago</span></p>
</div>
</div>
<div class="notification-delete d-flex align-items-center">
...
<p><span><i class="feather-mail"></i></span> <a href="https://truelysell.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f581878090998c86909999b5908d9498859990db969a98">[email&#160;protected]</a></p>
...
<ul>
<li>
<a href="#"><img src="assets/img/payment/visa.png" alt="img"></a>
</li>
<li>
<a href="#"><img src="assets/img/payment/mastercard.png" alt="img"></a>
</li>
<li>
<a href="#"><img src="assets/img/payment/stripe.png" alt="img"></a>
</li>
<li>
<a href="#"><img src="assets/img/payment/discover.png" alt="img"></a>
</li>
</ul>
</div>
</div>
...
<script data-cfasync="false" src="../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="assets/js/jquery-3.7.0.min.js" type="362ad0084decce6927b40646-text/javascript"></script>

<script src="assets/js/bootstrap.bundle.min.js" type="362ad0084decce6927b40646-text/javascript"></script>

<script src="assets/js/feather.min.js" type="362ad0084decce6927b40646-text/javascript"></script>

<script src="assets/js/moment.min.js" type="362ad0084decce6927b40646-text/javascript"></script>
<script src="assets/js/bootstrap-datetimepicker.min.js" type="362ad0084decce6927b40646-text/javascript"></script>

<script src="assets/js/owl.carousel.min.js" type="362ad0084decce6927b40646-text/javascript"></script>

<script src="assets/plugins/select2/js/select2.min.js" type="362ad0084decce6927b40646-text/javascript"></script>

<script src="assets/js/script.js" type="362ad0084decce6927b40646-text/javascript"></script>
<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="362ad0084decce6927b40646-|49" defer></script></body>
