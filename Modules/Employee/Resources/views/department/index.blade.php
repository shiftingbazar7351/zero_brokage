                    ...
                    <ul>
                        <li>
                            <button class="btn btn-primary" type="button" data-bs-toggle="modal"
                                data-bs-target="#add_branch"><i class="fa fa-plus me-2"></i>Add Department</button>
                        </li>
                    </ul>
                </div>
            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="table-imgname">
                                                    @if ($department->image)
                                                        <img src="{{ Storage::url('employee/department/' . $department->image) }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body pt-0">
                    <form id="addBranchForm" action="{{ route('employee-department.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="designation" name="designation_id">
                                ...
                                @foreach ($branchs as $designation)
