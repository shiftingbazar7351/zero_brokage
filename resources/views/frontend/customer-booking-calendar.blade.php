...
<!-- Mirrored from truelysell.dreamstechnologies.com/html/template/customer-booking-calendar.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Jul 2024 07:57:41 GMT -->
...
<head>
    ...
    <link rel="stylesheet" href="assets/plugins/fullcalendar/bootstrap-icons.css">
...
<body>
                ...
                <nav class="navbar navbar-expand-lg header-nav">
                    ...
                    <ul class="nav header-navbar-rht">
                        ...
                        <li class="nav-item flag-nav dropdown">
                            <div class="flag-dropdown">
                                <a class="dropdown-toggle nav-link" data-bs-toggle="dropdown" href="#" role="button">
                                    <img src="assets/img/flags/us.png" class="rounded-circle me-1" height="16"
                                        alt="Flag"> <span>USD</span>
                                </a>
                                <div class="dropdown-menu">
                                    <a href="javascript:void(0);" class="dropdown-item">
                        ...
                        <li class="nav-item dropdown logged-item noti-nav">
                            ...
                            <div class="dropdown-menu notify-blk notifications">
                                        ...
                                        <li class="notification-message">
                                            <div class="media d-flex">
                                                ...
                                                <div class="media-body flex-grow-1">
                                                    <a href="notification.html">
                                                        <p class="noti-details">Lex Murph <span class="noti-title">
                                                                requested access to</span> Computer & Server AMC Service
                                                        </p>
                                                    </a>
                                                    ...
                                                    <p class="noti-time"><span class="notification-time">Today 10:04
                                                            PM</span></p>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="notification-message">
                                            <a href="notification.html">
                                                <div class="media d-flex">
                                                    ...
                                                    <div class="media-body flex-grow-1">
                                                        <p class="noti-details">Ray Arnold <span class="noti-title">left
                                                                6 comments on</span> Commercial Painting Services</p>
                                                        <p class="noti-time"><span class="notification-time">Today 9:45
                                                                PM</span></p>
                                                    </div>
                                                </div>
                                            </a>
                                        ...
                                        <li class="notification-message">
                                            <a href="notification.html">
                                                <div class="media d-flex">
                                                    ...
                                                    <div class="media-body flex-grow-1">
                                                        <p class="noti-details">Dennis Nedry <span
                                                                class="noti-title">commented on</span> Electric Panel
                                                            Repairing Service </p>
                                                        <h6>“Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                                            sed do eiusmod tempor incididunt ut labore et commodo
                                                            consequat..”</h6>
                                        ...
                                        <li class="notification-message">
                                            <a href="notification.html">
                                                <div class="media d-flex">
                                                    ...
                                                    <div class="media-body flex-grow-1">
                                                        <p class="noti-details">John Hammond <span
                                                                class="noti-title">has booked your</span> House Cleaning
                                                            Services </p>
                                ...
                                <div class="topnav-dropdown-footer">
                                    <a href="notification.html">View More <img src="assets/img/icons/circle-icon.svg"
                                            alt="circle icon"></a>
                                </div>
                            </div>
                        </li>
                ...
                <div class="sidebar-body">
                    <div class="book-confirm bk-wrap">
                        ...
                        <div class="bk-action">
                            ...
                            <a href="#" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#alertmsg"><i
                        ...
                        <div class="d-flex flex-wrap">
                            <div class="book-email">
                                ...
                                <div>
                                    ...
                                    <p><a href="https://truelysell.dreamstechnologies.com/cdn-cgi/l/email-protection"
                                            class="__cf_email__"
                                            data-cfemail="23494c4b4d63465b424e534f460d404c4e">[email&#160;protected]</a>
                                    </p>
                                </div>
                            </div>
                            <div class="book-email-info">
                                ...
                                <a href="javascript:void(0)" class="btn btn-primary btn-mail"><img
                                        src="assets/img/icons/message.svg" alt="Message icon"> Chat</a>
                            </div>
                        </div>
                    </div>
                    <div class="bk-wrap">
                ...
                <div class="modal-content doctor-profile">
                    ...
                    <div class="modal-body pt-0">
                        <form action="#">
                            ...
                            <div class="modal-submit text-end">
                                <a href="#" class="btn btn-secondary me-2" data-bs-dismiss="modal">Dismiss</a>
    ...
    <script src="assets/js/jquery-3.7.0.min.js" type="e42c8e357263aa13c0fefb1f-text/javascript"></script>

    <script src="assets/js/bootstrap.bundle.min.js" type="e42c8e357263aa13c0fefb1f-text/javascript"></script>

    <script src="assets/js/feather.min.js" type="e42c8e357263aa13c0fefb1f-text/javascript"></script>

    <script src="assets/plugins/select2/js/select2.min.js" type="e42c8e357263aa13c0fefb1f-text/javascript"></script>

    <script src="assets/js/moment.min.js" type="e42c8e357263aa13c0fefb1f-text/javascript"></script>
    <script src="assets/js/bootstrap-datetimepicker.min.js" type="e42c8e357263aa13c0fefb1f-text/javascript"></script>

    <script src="assets/plugins/theia-sticky-sidebar/ResizeSensor.js"
        type="e42c8e357263aa13c0fefb1f-text/javascript"></script>
    <script src="assets/plugins/theia-sticky-sidebar/theia-sticky-sidebar.js"
        type="e42c8e357263aa13c0fefb1f-text/javascript"></script>

    <script src="assets/plugins/fullcalendar/main.min.js" type="e42c8e357263aa13c0fefb1f-text/javascript"></script>

    <script src="assets/js/script.js" type="e42c8e357263aa13c0fefb1f-text/javascript"></script>
    <script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="e42c8e357263aa13c0fefb1f-|49" defer></script>
</body>
