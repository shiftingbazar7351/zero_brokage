                        ...
                        <form id="addCategoryModal" action="{{ route('vendors.store') }}" method="POST"
                            ...
                            <div class="row mx-auto">
                                ...
                                <div class="col-md-3">
                                    <label for="companyname" class="form-label">Company Name</label><span> (if same
                                        name)</span>
                                    <input name="company_name" class="form-check-input mx-1" type="checkbox" value=""
                                        id="flexCheckChecked" checked>
                                    <input name="company_name" id="companyname" class="form-control bg-light-subtle"
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input name="legal_company_name" id="lcompanyname" class="form-control bg-light-subtle"
                                        type="text" placeholder="Company name" aria-label="default input example">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-4">
                                    ...
                                    <input name="pincode" id="pinnumber" class="form-control bg-light-subtle"
                            ...
                            <div class="row mt-4">
                                <div class="mb-3">
                                    <label for="exampleFormControlTextarea1" class="form-label text-dark">Example
                                        textarea</label>
                                    <textarea name="address" class="form-control bg-light-subtle" id="exampleFormControlTextarea1" rows="3"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-4">
                                    ...
                                    <input name="email" class="form-control bg-light-subtle" id="emailAddressVender"
                                ...
                                <div class="col-4">
                                    <label for="formFile" class="form-label">Whatsapp</label><span class="mx-3">(Get
                                        notification)</span>
                                    <input name="whatsapp" class="form-check-input mx-2" type="checkbox" value=""
                                        id="flexCheckChecked" checked>
                                    <input name="whatsapp" class="form-control bg-light-subtle" id="whatsappNumVender"
                                ...
                                <div class="col-4">
                                    <label for="phoneNumVender" class="form-label">Phone Number</label><span
                                        class="mx-3">(Get
                                        notification)</span>
                                    <input name="number" class="form-check-input mx-2" type="checkbox" value=""
                                        id="flexCheckChecked" checked>
                                    <input name="number" class="form-control bg-light-subtle" id="phoneNumVender"
                            ...
                            <div class="row mt-3">
                                <div class="col-4">
                                    ...
                                    <input name="website" class="form-control bg-light-subtle" type="text"
                            ...
                            <div class="row mt-3">
                                <div class="col-4 mb-3">
                                    ...
                                    <input name="logo" class="form-control bg-light-subtle" type="file"
                                        id="formFile">
                                </div>
                                <div class="col-4">
                                    <label for="formFile" class="form-label">Owner name</label>
                                    <input name="owner_name" class="form-control bg-light-subtle" type="text"
                                        placeholder="Enter owner name" aria-label="default input example">
                                </div>
                                <div class="col-4 mb-3">
                                    <label for="formFile" class="form-label">Vender Image</label>
                                    <input name="vendor_image" class="form-control bg-light-subtle" type="file"
                                        id="formFile">
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-3 mb-3">
                                    ...
                                    <input name="gst_image" class="form-control bg-light-subtle" type="file"
                                        id="GSTimage">
                                    <div id="gstImageError" class="text-danger"></div>
                                </div>
                                <div class="col-3">
                                    <label for="gstNumber" class="form-label">GST Number</label>
                                    <input name="gst_number" class="form-control bg-light-subtle" id="gstNumber"
                                ...
                                <div class="col-3 mb-3">
                                    ...
                                    <input name="pan_image" class="form-control bg-light-subtle" type="file"
                                        id="PanImage">
                                ...
                                <div class="col-3">
                                    ...
                                    <input name="pan_number" class="form-control bg-light-subtle" id="panCard"
                            ...
                            <div class="row mt-3">
                                <div class="col-3">
                                    ...
                                    <input name="adhar_numbere" class="form-control bg-light-subtle" id="adharvender"
                                ...
                                <div class="col-3 mb-3">
                                    ...
                                    <input name="adhar_image" class="form-control bg-light-subtle" type="file"
                                        id="adharImage">
