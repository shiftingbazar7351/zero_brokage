            ...
            <form id="addCategoryModal" action="{{ route('vendors.store') }}" method="POST" enctype="multipart/form-data" >
                ...
                <div class="row mx-auto">
                    ...
                    <div class="col-2">
                        ...
                        <select id="formFileCategory" class="form-select  bg-light-subtle"
                     ...
                     <div class="col-md-3">
                        ...
                        <input id="companyname" class="form-control bg-light-subtle" type="text"
                            placeholder="Company name" aria-label="default input example">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-4">
                        ...
                        <input id="pinnumber" class="form-control bg-light-subtle" type="text"
                            placeholder="PIN code number" maxlength="6" onkeyup="validateField(this)" aria-label="default input example">
